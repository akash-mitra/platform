                            ...
                            <div class="mx-auto max-w-md px-6 sm:max-w-2xl sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                                <div class="lg:py-24">
                                    <a href="#" class="inline-flex items-center rounded-full bg-black p-1 pr-2 text-white hover:text-gray-200 sm:text-base lg:text-sm xl:text-base">
                                        <span class="rounded-full bg-gradient-to-r from-teal-500 to-cyan-600 px-3 py-0.5 text-sm font-semibold leading-5 text-white">Start Building</span>
                                        <span class="ml-4 text-sm">Up Your Dev Game</span>
                                    ...
                                    <h1 class="mt-4 text-4xl font-bold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                        <span class="block">It's Kinda Like</span>
                                        <span class="block bg-gradient-to-r from-teal-200 to-cyan-400 bg-clip-text pb-3 text-transparent sm:pb-5">Netflix for Your Career!</span>
                                    </h1>
                                    <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">Learn practical, modern software development, through expert screencasts. Most video tutorials are boring. These aren't. So get ready to binge.</p>
                                    <div class="mt-10 sm:mt-12">
                                        <form action="#" class="sm:mx-auto sm:max-w-xl lg:mx-0">
                                            <div class="sm:flex">
                                                <div class="min-w-0 flex-1">
                                                    <button class="block w-full rounded-md bg-gradient-to-r from-teal-500 to-cyan-600 px-4 py-3 font-medium text-white shadow hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900">Create Free Account</button>
                                                </div>
                                                <div class="mt-3 sm:ml-3 sm:mt-0">
                                                    <button class="block w-full rounded-md bg-gray-500 px-4 py-3 font-medium text-white shadow hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900">Start Browsing &rarr;</button>
                                                </div>
                                            </div>
                                            <p class="mt-3 text-sm text-gray-300 sm:mt-4">Enough of LeetCode style problem solving. Now let's get real, shall we? Boost your career with the most concise screencasts for working developers.</p>
                                        </form>
                                    </div>
                                </div>
                            </div>
...
{{--                </div>--}}
                ...
                <div class="relative bg-white py-16 sm:py-24 lg:py-32">
                    <div class="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
                        <h2 class="text-lg font-semibold text-cyan-600">Up Your Dev Game with</h2>
                        <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">The most concise screencasts for the working developer</p>
                        <p class="mx-auto mt-5 max-w-prose text-xl text-gray-500">Plenty of educational resources will teach you how to code. But what about those of us who already do that full-time, every day? Where do we go to further our education?</p>
                        <div class="mt-12">
